  ...
  return (
    <div className="text-center selection:bg-green-900">
      <header className="flex min-h-screen flex-col items-center justify-center bg-[#282c34] text-white">
        ...
        <p>Hi {hello}</p>
        <p className="bg-gradient-to-r from-emerald-300 to-sky-300 bg-clip-text text-4xl font-medium text-transparent selection:bg-transparent">
        ...
        <p className="mt-3 flex flex-row gap-2">
          <button
            type="button"
            className="my-6 rounded bg-gray-300 p-2 text-[#282C34] transition-all hover:bg-gray-200"
            onClick={() => handleLogin()}
          >
            Login
          </button>
